...
-- Final categories balancer with deduplication after quota selection
...
BEGIN
    ...
    EXECUTE format('DROP TABLE IF EXISTS %I.%I_quota_i3_selected', target_schema, table_prefix);
    EXECUTE format('
