...
class TrackSearchParamsTest {
    ...
    void constructor_shouldCreateInstanceWithAllParameters() {
        ...
        // When
        TrackSearchParams params = new TrackSearchParams(search, minPlayCount, minListenersCount, artistId, approvalStatuses, tagId);
    ...
    void constructor_shouldHandlePartialParameters() {
        ...
        // When
        TrackSearchParams params = new TrackSearchParams(search, null, null, artistId, null, null);
    ...
    void constructor_shouldHandleTagIdParameter() {
        ...
        // When
        TrackSearchParams params = new TrackSearchParams(null, null, null, null, null, tagId);
    ...
    void equals_shouldReturnTrue_whenObjectsAreEqual() {
        ...
        TrackSearchParams params1 = new TrackSearchParams(search, minPlayCount, minListenersCount, artistId, approvalStatuses, tagId);
        TrackSearchParams params2 = new TrackSearchParams(search, minPlayCount, minListenersCount, artistId, approvalStatuses, tagId);
    ...
    void equals_shouldReturnFalse_whenObjectsAreDifferent() {
        // Given
        TrackSearchParams params1 = new TrackSearchParams("test1", 1000L, 500L, 123L, null, null);
        TrackSearchParams params2 = new TrackSearchParams("test2", 1000L, 500L, 123L, null, null);
    ...
    void toString_shouldReturnNonEmptyString() {
        // Given
        TrackSearchParams params = new TrackSearchParams("test", 1000L, 500L, 123L, null, 456L);
