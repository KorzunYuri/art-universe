...
public class LastfmArtistApiCallGeneratorTest extends JpaOnlyTest {
     ...
     * <ol>
     *     <li>{@link LastfmArtistApiCallsGenerator} class. Instance will be retrieved from {@link ApplicationContext} in runtime,
    ...
    private LastfmArtistApiCallsGenerator getGenerator(Class<? extends LastfmArtistApiCallsGenerator> clazz) {
        LastfmArtistApiCallsGenerator generator = ctx.getBean(clazz);
    ...
    void getApiCallType_shouldReturnExpectedType(
        ...
        LastfmArtistApiCallsGenerator generator = getGenerator(generatorClass);
    ...
    private void mockUnprocessedArtistRetrieval(LastfmArtistApiCallsGenerator generator, List<LastfmArtist> unprocessedArtists) {
