package yurykorzun.art.universe.music.data.raw.lastfm.collectable.album.controller;
...
class LastfmAlbumControllerMvcTest extends BaseMvcTest {
    ...
    void GET_albumById_shouldReturnAlbum_whenFound() throws Exception {
        ...
        when(albumService.findDtoById(eq(albumId)))
    ...
    @Test
    void PATCH_albumApproval_shouldUpdateApprovalStatus_whenValidStatusProvided() throws Exception {
