...
import yurykorzun.art.universe.music.data.raw.lastfm.task.response.process.mapping.factory.tag.toptracks.LastfmTagTopTracksTrackFactory;
...
public class LastfmTagTopTracksResponseProcessor extends LastfmApiResponseProcessor<TagTopTracksDtoRoot> {
    ...
    protected LastfmTagTopTracksResponseProcessor(
        ...
        super(TagTopTracksDtoRoot.class, objectMapper);
