...
/**
 * Integration test for specific {@link BaseLastfmEntityRelationService} implementations
 */
@Import({
...
@Tag("integration")
class EntityRelationServiceImplementationsTest extends LastfmJpaTestHelper {
