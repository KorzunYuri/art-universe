package yurykorzun.art.universe.music.data.raw.lastfm.task.call.perform.aspect;
...
import yurykorzun.art.universe.music.data.raw.lastfm.task.call.perform.LastfmApiCallExecutor;
...
public class ApiCallPerformerObservabilityAspect {
    ...
    /**
     * Intercepts all executions of {@link LastfmApiCallExecutor#execute(LastfmApiCall)}
     ...
     */
    @Around("execution(* yurykorzun.art.universe.music.data.raw.lastfm.task.call.perform.LastfmApiCallExecutor+.execute(..)) && args(call)")
