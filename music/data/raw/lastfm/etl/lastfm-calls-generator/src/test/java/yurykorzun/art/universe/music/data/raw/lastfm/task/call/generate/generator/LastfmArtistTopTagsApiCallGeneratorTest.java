...
class LastfmArtistTopTagsApiCallGeneratorTest {
    ...
    void getApiCallType_shouldReturnCorrectType() {
        ...
        // then
        assertEquals(LastfmApiCallType.ARTIST_TOP_TAGS, result);
    }
    ...
    void getDueDurationDays_shouldReturnConfiguredValue() {
        // given
        int expectedDays = 7;
        when(configPropertyHolder.getInt(LastfmGeneratorProperty.DUE_DURATION_ARTIST_TOP_TAGS)).thenReturn(expectedDays);
