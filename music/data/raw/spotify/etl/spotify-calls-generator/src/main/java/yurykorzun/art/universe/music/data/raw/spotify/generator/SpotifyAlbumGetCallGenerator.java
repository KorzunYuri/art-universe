...
public class SpotifyAlbumGetCallGenerator extends BaseSpotifyApiCallGenerator {
    ...
    public void createApiCalls() {
        ...
        int dueDurationDays = configPropertyHolder.getInt(SpotifyGeneratorProperty.DUE_DURATION_ALBUM_GET);
