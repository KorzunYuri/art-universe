...
class ArtistDiversityProcessorTest {
    ...
    void setUp() {
        ...
        processor = new ArtistDiversityProcessor(stepRunRepository, stepRepository, objectMapper);
