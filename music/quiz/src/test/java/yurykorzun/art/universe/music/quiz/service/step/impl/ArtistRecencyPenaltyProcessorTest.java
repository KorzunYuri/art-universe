...
class ArtistRecencyPenaltyProcessorTest {
    ...
    void setUp() {
        ...
        processor = new ArtistRecencyPenaltyProcessor(stepRunRepository, stepRepository, objectMapper);
    ...
    @Test
    void getStepSuffix_shouldReturnArtistrecency() {
        // when
        String result = ReflectionTestUtils.invokeMethod(processor, "getStepSuffix");

        // then
        assertEquals("artistrecency", result);
    }
}
