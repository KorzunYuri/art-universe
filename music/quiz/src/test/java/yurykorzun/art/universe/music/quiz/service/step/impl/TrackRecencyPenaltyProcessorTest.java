...
class TrackRecencyPenaltyProcessorTest {
    ...
    void setUp() {
        ...
        processor = new TrackRecencyPenaltyProcessor(stepRunRepository, stepRepository, objectMapper);
    ...
    @Test
    void getStepSuffix_shouldReturnTrackrecency() {
        // when
        String result = ReflectionTestUtils.invokeMethod(processor, "getStepSuffix");

        // then
        assertEquals("trackrecency", result);
    }
}
