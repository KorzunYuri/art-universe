-- Filter out tracks by blacklisted artist categories - simplified version using p_ensure_chance_column
...
BEGIN
    ...
    ', target_schema, output_table_name, input_table_with_chance, blacklist_schema, blacklist_table);
