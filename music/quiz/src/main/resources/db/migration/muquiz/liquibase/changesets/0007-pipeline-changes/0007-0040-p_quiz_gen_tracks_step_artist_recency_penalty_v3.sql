-- Update artist recency penalty to use new table naming convention
DROP FUNCTION IF EXISTS p_quiz_gen_tracks_step_artist_recency_penalty;
...
BEGIN
    output_table_name := p_quiz_gen_tracks_get_tablename_prefix(game_id, generation_id, step_order) || '_artist_recency_out';
