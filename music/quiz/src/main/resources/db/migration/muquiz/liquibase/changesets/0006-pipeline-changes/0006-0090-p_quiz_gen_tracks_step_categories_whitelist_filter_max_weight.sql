-- Fix whitelist filter to apply MAX weight rule when artist matches multiple categories
...
BEGIN
    ...
    ', target_schema, output_table_name, columns_list, input_table_with_chance, whitelist_schema, whitelist_table, group_by_list);
