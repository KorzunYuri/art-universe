-- Update artist diversity to use new table naming convention
DROP FUNCTION IF EXISTS p_quiz_gen_tracks_step_artist_diversity;
...
BEGIN
    output_table_name := p_quiz_gen_tracks_get_tablename_prefix(game_id, generation_id, step_order) || '_diversity_out';
