-- Main pipeline procedure that orchestrates all generation steps
-- Input: game_id, generation_id, target_count
-- Output: final table name with generated tracks
...
BEGIN
    ...
    -- Step 3: Apply artist diversity penalty
    table_name_full := p_quiz_gen_tracks_step_artist_diversity(schema_name, table_name, game_id, generation_id, 3);
    ...
    table_name_full := p_quiz_gen_tracks_step_final_selection(schema_name, table_name, game_id, generation_id, 4, target_count);
