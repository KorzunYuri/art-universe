-- Include only whitelisted artist categories - simplified version using p_ensure_chance_column
...
BEGIN
    ...
    ', target_schema, output_table_name, columns_list, input_table_with_chance, whitelist_schema, whitelist_table);
