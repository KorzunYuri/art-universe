...
export const AlbumsTable = () => {
    ...
    const columns = useMemo<ColumnDef<Album, any>[]>(() => {
        const cols: ColumnDef<Album, any>[] = [
            {
                accessorKey: 'name',
                header: 'Name',
                enableSorting: true,
                meta: { headerClassName: styles.name, cellClassName: styles.name },
                cell: ({ row }) => <NameCell album={row.original} onSaved={refresh} readOnly={!canEdit} />,
            },
            {
                id: 'primaryArtist',
            ...
            },
            {
                ...
                cell: ({ row }) => <CategoriesCell album={row.original} onChanged={refresh} readOnly={!canEdit} />,
            },
        ];
