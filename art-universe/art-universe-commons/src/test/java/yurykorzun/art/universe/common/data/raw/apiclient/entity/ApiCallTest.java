...
class ApiCallTest {
    ...
    private static final Supplier<ApiCall> validApiCallSupplier = () -> ApiCall.builder()
    ...
    void testValidApiCallStatusTransition() {
        ApiCall call = validApiCallSupplier.get();
        call.setStatus(ApiCallStatus.SCHEDULED);
        assertEquals(ApiCallStatus.SCHEDULED, call.getStatus());
    }
