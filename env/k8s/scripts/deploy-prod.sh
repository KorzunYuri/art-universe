...
# Usage: ./deploy-prod.sh [--skip-ingress-check] [--timeout 600]
...
echo -e "\033[36mDeploying Art Universe to production Kubernetes...\033[0m"
...
# Check secrets
SECRETS_FILE="$K8S_DIR/overlays/prod/secrets/secrets.yaml"
if [ ! -f "$SECRETS_FILE" ]; then
    echo -e "\n\033[33mWarning: secrets.yaml not found at $SECRETS_FILE\033[0m"
    echo -e "\033[33m  Copy secrets.yaml.template and fill in your credentials.\033[0m"
    echo -e "\033[33m  See secrets/README.md for setup instructions.\033[0m"
...
echo -e "\n\033[33mCreating namespaces...\033[0m"
kubectl apply -f "$K8S_DIR/base/namespaces.yaml"
echo -e "\033[32mNamespaces created.\033[0m"
...
echo -e "\n\033[33mApplying Kubernetes manifests (prod overlay)...\033[0m"
...
# Summary
echo -e "\n\033[36m========================================\033[0m"
echo -e "\033[36mProduction Deployment Complete!\033[0m"
...
echo -e "  \033[32m- UI:                  http://localhost:3000\033[0m"
echo -e "  \033[32m- Music Data API:      http://localhost:8082\033[0m"
echo -e "  \033[32m- Music Quiz API:      http://localhost:8083\033[0m"
echo -e "  \033[32m- LastFM REST API:     http://localhost:8084\033[0m"
echo -e "  \033[32m- LastFM ETL REST API: http://localhost:8085\033[0m"
